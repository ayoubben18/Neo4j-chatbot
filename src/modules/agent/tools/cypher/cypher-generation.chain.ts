...
export default async function initCypherGenerationChain(
    ...
    const cypherPrompt = PromptTemplate.fromTemplate(`You are a Neo4j Developer translating user questions into Cypher to answer questions
...
{question}`)
    ...
    return RunnableSequence.from<string, string>([{
        ...
        cypherPrompt, llm, new StringOutputParser()])
}
// end::function[]
